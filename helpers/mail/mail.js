        ...
        <div style="
          ...
          ">
            ...
            <div style="font-weight: 400; color: black; opacity: 0.7; font-size: 14px">
              ...
              <div><span>Contact : </span><span> ${cs?.phone?? "N/A"} </span></div>
    ...
    <body>
        <div style="
          ...
          ">
            ...
            "></div>
            <div style="font-weight: 400; color: black; opacity: 0.7; font-size: 14px">
                Votre souscription a été validé avec succès. Voici les détails:
              ...
              <div><span>Nombre de comptes : </span><span> ${souscription_type?.type} </span></div>
                ...
                <div style="margin-top: 20px; margin-bottom: 20px">
                    Vous avez desormais accès à la plateforme de connexion via vos identifiants (email et mot de passe) renseignés lors de la demande de souscription.
                    <code style="display: block; padding: 12px">
                    <div><span>Email : </span><span>support@healthp.com</span></div>
                    <div><span>Contact : </span><span>+228 99101748</span></div>
                </code>
    ...
    <div style="
      ...
      <div style="font-weight: 400; color: black; opacity: 0.7; font-size: 14px">
        ...
        <code style="display: block; padding: 12px">
            ...
            <div><span>Sexe  : </span><span> ${patient?.sexe == "M" ? 'Masculin' : "Féminin"}</span></div>
